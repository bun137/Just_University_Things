...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_T_STRLITERAL = 29,              /* T_STRLITERAL  */
  YYSYMBOL_30_ = 30,                       /* ';'  */
  YYSYMBOL_31_ = 31,                       /* ','  */
  YYSYMBOL_32_ = 32,                       /* '='  */
  YYSYMBOL_33_ = 33,                       /* '+'  */
...
{
       0,    36,    36,    43,    44,    45,    46,    50,    54,    55,
      59,    69,    81,    82,    83,    84,    88,   102,   103,   107,
     115,   123,   127,   135,   148,   152,   153,   165,   166,   170,
     171,   172,   173,   174,   175,   179,   183,   184,   188,   189,
     190,   194,   195,   199
};
#endif
...
static const char *const yytname[] =
{
  ...
  "T_ELSE", "T_DO", "T_INCLUDE", "T_HEADER", "T_MAIN", "T_ID", "T_NUM",
  "T_STRLITERAL", "';'", "','", "'='", "'+'", "'-'", "'*'", "'/'", "'('",
...
{
      10,   -25,   -25,   -25,   -25,    23,    46,   -25,    30,   -15,
      31,    10,   -10,   -25,    10,    25,    32,    34,   -25,    10,
     -25,   -25,   -25,   -25,   -10,    -4,   -12,    18,   -25,   -25,
      36,   -10,    36,   -25,    -8,   -25,   -25,   -25,   -25,   -25,
     -25,   -10,   -10,   -10,   -10,   -10,    34,    28,    -4,   -25,
     -25,   -12,    18,    18,   -25,   -25,    26,    -3,    -3,    38,
      36,    39,    29,    -3,    -3,    33,   -25,   -25,   -25,   -25,
     -25,   -25
};
...
{
     -25,   -25,     9,   -24,    40,    41,   -16,   -14,    21,    35,
     -17,    14,   -25,   -25,   -25,    -7,   -25,   -25
};
...
static const yytype_int8 yytable[] =
{
      ...
      38,    15,    16,     1,     2,     3,     4,    21,    22,    23,
      20,    42,    43,    29,     5,    52,    53,    24,    33,     4,
      50,    39,    40,    59,    59,    39,    40,     5,    58,    59,
      59,    60,    60,    61,    61,    34,    13,    60,    60,    61,
      61,    65,    48,    44,    45,    12,    69,    70,    54,    55,
      14,    19,    30,    16,    31,    32,    56,    57,    66,    67,
      46,    68,     0,    49,     0,    71,    51
};
...
static const yytype_int8 yycheck[] =
{
      ...
      14,    26,    27,     3,     4,     5,    19,    27,    28,    29,
      11,    33,    34,    14,    27,    42,    43,    37,    19,    19,
      38,    39,    40,    57,    58,    39,    40,    27,    41,    63,
      64,    57,    58,    57,    58,    24,     0,    63,    64,    63,
      64,    58,    31,    35,    36,    32,    63,    64,    44,    45,
      30,    30,    37,    27,    32,    31,    38,    41,    30,    30,
      30,    42,    -1,    32,    -1,    42,    41
};
...
{
       0,     3,     4,     5,    19,    27,    44,    45,    46,    49,
      50,    56,    32,     0,    30,    26,    27,    47,    48,    30,
      45,    27,    28,    29,    37,    51,    52,    53,    54,    45,
...
#line 59 "parser.y"
                    {
                if (lookup_symbol((yyvsp[-2].str), current_scope) != NULL) {
                    printf("Variable %s already declared\n", (yyvsp[-2].str));
                    yyerror((yyvsp[-2].str));
                } else {
                    double val = atof((yyvsp[0].str));
                    insert_symbol((yyvsp[-2].str), current_type, yylineno, current_scope, 0, val);
                }
...
#line 69 "parser.y"
           {
                if (lookup_symbol((yyvsp[0].str), current_scope) != NULL) {
                    printf("Variable %s already declared\n", (yyvsp[0].str));
                    yyerror((yyvsp[0].str));
                } else {
                    insert_symbol((yyvsp[0].str), current_type, yylineno, current_scope, 0, 0.0);
                }
...
#line 1318 "y.tab.c"
  ...
  case 12: /* TYPE: T_INT  */
#line 81 "parser.y"
               { current_type = 2; (yyval.str) = "int"; }
#line 1324 "y.tab.c"
    break;

  case 13: /* TYPE: T_FLOAT  */
#line 82 "parser.y"
               { current_type = 3; (yyval.str) = "float"; }
#line 1330 "y.tab.c"
    break;

  case 14: /* TYPE: T_DOUBLE  */
#line 83 "parser.y"
               { current_type = 3; (yyval.str) = "double"; }
#line 1336 "y.tab.c"
    break;

  case 15: /* TYPE: T_CHAR  */
#line 84 "parser.y"
               { current_type = 1; (yyval.str) = "char"; }
#line 1342 "y.tab.c"
    break;
...
#line 88 "parser.y"
                    {
                Symbol* sym = lookup_symbol((yyvsp[-2].str), current_scope);
                if (sym == NULL) {
                    printf("Error: %s not declared\n", (yyvsp[-2].str));
                    yyerror((yyvsp[-2].str));
                } else {
                    double val = atof((yyvsp[0].str));
                    update_symbol((yyvsp[-2].str), val);
                }
                (yyval.str) = (yyvsp[-2].str);
            }
#line 1358 "y.tab.c"
...
#line 107 "parser.y"
              {
                    double l = atof((yyvsp[-2].str));
                    double r = atof((yyvsp[0].str));
                    double res = l + r;
                    char buf[64];
                    sprintf(buf, "%lf", res);
...
#line 153 "parser.y"
           {
                    Symbol* sym = lookup_symbol((yyvsp[0].str), current_scope);
                    if(sym == NULL) {
