    ...
    if(*pstart == NULL){
        *pstart = newnode;
        ...
        if((*pstart) -> llink == NULL){// in the first pos bc llink is null
            (*pstart) -> llink=newnode; // use *pstart to modify, change in dstart doesnt reflect
            newnode->rlink = *pstart;
            *pstart = newnode;
        }
        else{
            ...
            newnode -> llink = dstart -> llink; // change where llink of newnode points to
            dstart -> llink = newnode; // changing the prev llink to point to the newnode
            dstart = newnode;  }
